...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mkcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mkcointools.com", "dnsseed.mkcointools.com"},
    {"mkcoinpool.org", "dnsseed.mkcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"mkcointools.com", "testnet-seed.mkcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mkcoin is probably already running."), addrBind.ToString().c_str());
        else
